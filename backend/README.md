...
## Project Structure
    ...
    ├── testopenapierror_d_109174  # Django project configurations
...
1. Clone this repo and `cd testopenapierror_d_109174`
...
2. Clone this repo and `cd testopenapierror_d_109174`
